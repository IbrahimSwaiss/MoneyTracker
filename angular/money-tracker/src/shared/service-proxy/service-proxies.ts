...
export class MoneyServiceProxy {
    ...
    addBudget(name: string | null | undefined, monthlyBudget: number | undefined, weeklyBudget: number | undefined, monthlySavingAmount: number | undefined, monthlySavingPercentage: number | undefined, transactions: Transaction[] | null | undefined, isDeleted: boolean | undefined, deletedBy: number | null | undefined, deletedOn: moment.Moment | null | undefined, createdBy: number | undefined, createdOn: moment.Moment | undefined, modifiedBy: number | null | undefined, modifiedOn: moment.Moment | null | undefined, id: number | undefined): Observable<void> {
        ...
        if (transactions !== undefined)
            transactions && transactions.forEach(item => { url_ += "Transactions=" + encodeURIComponent("" + item) + "&"; });
        if (isDeleted === null)
        ...
        if (deletedBy !== undefined)
            url_ += "DeletedBy=" + encodeURIComponent("" + deletedBy) + "&"; 
        if (deletedOn !== undefined)
            url_ += "DeletedOn=" + encodeURIComponent(deletedOn ? "" + deletedOn.toJSON() : "") + "&"; 
        if (createdBy === null)
        ...
        if (modifiedOn !== undefined)
            url_ += "ModifiedOn=" + encodeURIComponent(modifiedOn ? "" + modifiedOn.toJSON() : "") + "&"; 
        if (id === null)
...
export class AuditedEntityOfInt32 extends EntityOfInt32 implements IAuditedEntityOfInt32 {
    createdBy!: number;
    createdOn!: moment.Moment;
    modifiedBy!: number | undefined;
    modifiedOn!: moment.Moment | undefined;

    constructor(data?: IAuditedEntityOfInt32) {
        super(data);
    }
    ...
    static fromJS(data: any): AuditedEntityOfInt32 {
        data = typeof data === 'object' ? data : {};
        let result = new AuditedEntityOfInt32();
        result.init(data);
        return result;
    }
...
export interface IAuditedEntityOfInt32 extends IEntityOfInt32 {
    createdBy: number;
    createdOn: moment.Moment;
    modifiedBy: number | undefined;
    modifiedOn: moment.Moment | undefined;
...
export class FullAuditedEntityOfInt32 extends AuditedEntityOfInt32 implements IFullAuditedEntityOfInt32 {
    isDeleted!: boolean;
    deletedBy!: number | undefined;
    deletedOn!: moment.Moment | undefined;

    constructor(data?: IFullAuditedEntityOfInt32) {
        super(data);
    }
    ...
    static fromJS(data: any): FullAuditedEntityOfInt32 {
        data = typeof data === 'object' ? data : {};
        let result = new FullAuditedEntityOfInt32();
        result.init(data);
        return result;
    }
...
export interface IFullAuditedEntityOfInt32 extends IAuditedEntityOfInt32 {
    isDeleted: boolean;
    deletedBy: number | undefined;
    deletedOn: moment.Moment | undefined;
}

export class Transaction extends FullAuditedEntityOfInt32 implements ITransaction {
...
export interface ITransaction extends IFullAuditedEntityOfInt32 {
    name: string | undefined;
    repeat: number;
    amount: number;
    budgetId: number;
